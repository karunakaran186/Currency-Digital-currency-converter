...
root.title("Currency converter: Devloped by Codecrusher Karan")
...
headlabel = tk.Label(Tops, font=('lato black', 19, 'bold'), text='Currency converter : Devloped by Codecrusher Karan ',
                    bg='#e6e5e5', fg='black')
